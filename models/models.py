...
class Order(Base):
  ...
  price = Column('price', Numeric(asdecimal=False))
  ...
  marker_sell_price = Column('marker_sell_price', Numeric(asdecimal=False))
...
class DailyConfig(Base):
  ...
  daily_profit_stop_limit_percent = Column('daily_profit_stop_limit_percent', Numeric(asdecimal=False))
  daily_loss_margin = Column('daily_loss_margin', Numeric(asdecimal=False))
  daily_profit_margin = Column('daily_profit_margin', Numeric(asdecimal=False))
  daily_profit_stop_margin = Column('daily_profit_stop_margin', Numeric(asdecimal=False))
  daily_profit_stopped_value = Column('daily_profit_stopped_value', Numeric(asdecimal=False))
...
class TradeConfig(Base):
  ...
  partial_stop_loss_rate = Column('partial_stop_loss_rate', Numeric(asdecimal=False), default=0.5)
  partial_stop_loss_count = Column('partial_stop_loss_count', Numeric(asdecimal=False), default=0.5)
